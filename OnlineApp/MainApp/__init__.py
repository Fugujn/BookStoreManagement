...
from MainApp.models import Role, User, Configuration, Book, Category, Author, PaymentMethod, Comment
...
from MainApp.books.routes import books
from MainApp.orders.routes import orders
from MainApp.cart.routes import cart
...
def build_sample_db():
    ...
    with app.app_context():
        ...
        # Book
        with open('MainApp/static/data_import/book_data.json', 'rb') as f:
            data = json.load(f)
            for book in data:
